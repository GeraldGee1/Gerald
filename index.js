/**
 * ᬊ͜͡𝙈𝙧ܓRUTHLESSNESS-MD v3.0 — All-in-One Multi-User Bot
...
app.post('/pair', async (req, res) => {
    ...
    if (phone.length < 7 || phone.length > 15)
        return res.status(400).json({ error: 'Invalid number. Use international format e.g. 233598711173' });
        ...
        if (connection === 'open') {
            ...
            try {
                ...
                await sock.sendMessage(botNum, {
                    text: `🎉 *💀 *ᬊ͜͡𝙈𝙧ܓRUTHLESSNESS-MD is LIVE!*!*\n\n✅ Your bot is now *LIVE!*\n\n*Try these:*\n• *.help* — all commands\n• *.ping* — check speed\n• *.ai hello* — AI chat\n• *.mode private* — private mode\n\n🌐 ${APP_URL}\n\n_ᬊ͜͡𝙈𝙧ܓRUTHLESSNESS-MD©_`
                });
            } catch {}
                ...
                if (await isOwnerFn(sender, sock, chatId)) {
                    ...
                    if (fs.existsSync(credsFile)) {
                        ...
                        await sock.sendMessage(chatId, {
                            ...
                            fileName: `ᬊ͜͡𝙈𝙧ܓRUTHLESSNESS-MD_SESSION_${phone}.txt`,
                            mimetype: 'text/plain',
                            caption: '🔐 Your SESSION_ID\n\n_ᬊ͜͡𝙈𝙧ܓRUTHLESSNESS-MD©_'
                        }, { quoted: mek });
                    } else {
                        await sock.sendMessage(chatId, { text: '❌ No session file.\n\n_ᬊ͜͡𝙈𝙧ܓRUTHLESSNESS-MD©_' }, { quoted: mek });
                    }
                    return;
                }
            }
